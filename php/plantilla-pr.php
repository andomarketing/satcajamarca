<div class="main" style="display: block; width: 100% ; height: 155mm; font-size: 6pt; font-family: Arial; font-weight: bold; page-break-after: always;">
    ...
    <table class="pre1-table">
        ...
        <tr class="pre1-tr">
            <td class="pre1-td pre1-td-left"><span class="white-text" style="margin-right: 2mm">CÓDIGO PREDIO: </span> <?php echo $PR["predio_id"]; ?></td>
            <td class="pre1-td pre1-td-rigth"><span class="white-text" style="margin-right: 2mm">CÓDIGO CATASTRAL: </span> <?php echo $PR["codigoCatastral"]; ?></td>
        </tr>
        <tr class="pre1-tr">
            <td class="pre1-td pre1-td-left" colspan="2" style="font-size: 5pt;"><span class="white-text" style="margin-right: 4mm">DIRECCIÓN DE PREDIO:</span> <span style="font-size: 5pt;"> <?php echo strtoupper( $PR["direccion_completa"] ); ?></span></td>
        </tr>
    </table>
    <!-- DATOS DEL PREDIO -->
    ...
    <table class="pre4-table">
        <tr class="pre4-tr">
            <td class="pre4-td pre4-td-left"><span class="white-text">AREA DEL TERRENO HA: </span> <span style="font-size: 6pt; position: absolute; top: 2.7mm; right: 9mm"> <?php echo number_format($PR["area"], 2, ',', '.') ?> </span> </td>
            <td class="pre4-td pre4-td-center"><span class="white-text">VALOR ARANCELARIO: </span> <span style="font-size: 6pt; position: absolute; top: 2.7mm; right: 8mm"> <?php echo number_format($PR["arancel"], 2, ',', '.') ?> </span> </td>
            <td class="pre4-td pre4-td-rigth"><span class="white-text">VALOR TERNARIO: </span> <span style="font-size: 6pt; position: absolute; top: 2.7mm; right: 2.5mm"> <?php echo number_format($PR["valor_terreno"], 2, ',', '.') ?> </span> </td>
        </tr>
    </table>
    <!-- DETERMINACION DEL VALOR DEL PRECIO -->
    ...
    <table class="const-table">
        <tr style="height: 23mm">
            ...
            <td style="width: 5mm; vertical-align: bottom; padding-bottom: 2mm;"><span class="vertical-text white-text"></span></td>
        ...
        <tr style="height: 5mm; vertical-align: bottom;">
            ...
            <td></td>
            <td style="font-size: 6pt;"> <?php echo number_format($PR["valor_construccion"], 2, ',', '.') ?></td>
        </tr>
        <!-- TOTALES -->
    </table>
    <!-- CONSTRUCCIONES -->
    ...
    <table class="comp-table" style="height: 21.3mm">
        <tr style="height: 6mm">
    ...
    <table class="comp-table">
        ...
        <tr style="height: 3.666666666666667mm; vertical-align: middle;">
            <td colspan="4"></td>
            <td colspan="4" style="font-size: 3pt; text-align: left; padding: 1mm;"> <span class="white-text">VALOR DE LA CONSTRUCCIÓN</span></td>
            <td colspan="2" style="font-size: 6pt"><?php echo number_format($PR["valor_construccion"], 2, ',', '.') ?></td>
        </tr>
        <tr style="height: 3.666666666666667mm; vertical-align: middle;">
            <td colspan="4"></td>
            <td colspan="4" style="font-size: 3pt; text-align: left; padding: 1mm"> <span class="white-text">VALOR DE LA CONSTRUCCIÓN</span></td>
            <td colspan="2" style="font-size: 6pt"><?php echo number_format($PR["valor_terreno"], 2, ',', '.') ?></td>
        </tr>
        <tr style="height: 3.666666666666667mm; vertical-align: middle;">
            <td colspan="4"></td>
            <td colspan="4" style="font-size: 3pt; text-align: left; padding: 1mm"> <span class="white-text">VALOR DE LA CONSTRUCCIÓN</span></td>
            <td colspan="2" style="font-size: 6pt"><?php echo number_format($PR["valor_instalacion"], 2, ',', '.') ?></td>
        </tr>
        <tr style="height: 3.3mm; vertical-align: middle;">
            <td colspan="4"></td>
            <td colspan="4" style="font-size: 3pt; text-align: left; padding: 1mm"> <span class="white-text">VALOR DE LA CONSTRUCCIÓN</span></td>
            <td colspan="2" style="font-size: 6pt"><?php echo number_format($PR["base_imponible"], 2, ',', '.') ?></td>
        </tr>
    </table>
    <!-- DETERMINACION DEL VALOR DE LAS OBRAS -->
</div> 

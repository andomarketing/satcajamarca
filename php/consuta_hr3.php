...
while ($contribuyente = $consulta_contribuyente->fetch_array()) {
    ...
    if($cant_hr > 11 || $cant_realacionados > 5){
        ...
        while ( $n_paginas_hr >= $conta_hr || $n_paginas_relacionados >= $conta_relacionados) {
            ...
            <span style="position: absolute; top: 35mm; left: 85.5mm;"> <?php echo $contribuyente["NroDeclaracionJurada"]; ?> </span>
            <span style="position: absolute; top: 45mm; left: 119.2mm;"><?php echo $contribuyente["emision"]; ?> </span>

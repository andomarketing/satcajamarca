...
?>
    <div style="width: 100%; height: 370mm;display:block; position:relative; font-size: 10pt; font-family: Arial; font-weight: bold; page-break-after: always;">
        ...
        <span style="position: absolute; top: 60mm; left: 194.8mm;"><?php echo $contribuyente["emision"]; ?> </span>
        <span style="position: absolute; top: 73mm; left: 80mm;" ><?php echo $contribuyente["persona_id"]; ?> </span>
        <span style="position: absolute; top: 87mm; left: 55mm;" ><?php echo $contribuyente["apellidos_nombres"]; ?> </span>
        <!-- DATOS DEL CONTRIBUYENTE -->

        <!-- DETERMINACION DE BASE IMPONIBLE HLP -->
        <table style="position: absolute; top: 120mm; width: 80%; font-size: 8pt; font-weight: bold; left: 10%; text-align: center;">
            <tbody>
        ...
        <table style="position: absolute; top: 146mm; width: 30%; font-size: 9pt; font-weight: bold; left: 150mm; text-align: center;">
            <tbody>
        ...
        <!-- CRONOGRAMA DE PAGOS -->
        <table style="position: absolute; top: 202mm; width: 76%; font-size: 9pt; font-weight: bold; left: 12%; text-align: center;">
            <tbody>

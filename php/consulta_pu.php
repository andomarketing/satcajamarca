...
while ($contribuyente = $consulta_contribuyente->fetch_array()) {
    ...
    if($cant_hr > 6 || $cant_realacionados > 5){
        ...
        while ( $n_paginas_hr >= $conta_hr || $n_paginas_relacionados >= $conta_relacionados) {
            ...
            <div style="width:221mm; height: 297mm; position:relative; font-size: 9pt; font-family: Arial; font-weight: bold; page-break-after: always; background: url('../img/pu.png'); background-size: cover;">
                ...
                <table style="position: absolute; top: 115mm; width: 86%; font-size: 7pt; font-weight: bold;left: 36mm; text-align: center;">
                    <tbody>
    <?php

...
while ($contribuyente = $consulta_contribuyente->fetch_array()) {
    ...
    if($cant_hr > 11 || $cant_realacionados > 5){
        ...
        while ( $n_paginas_hr >= $conta_hr || $n_paginas_relacionados >= $conta_relacionados) {
            ...
            <span style="position: absolute; top: 37.2mm; left: 101.5mm;"> <?php echo $contribuyente["NroDeclaracionJurada"]; ?> </span>
            <span style="position: absolute; top: 47.7mm; left: 133.2mm;"><?php echo $contribuyente["emision"]; ?> </span>
            <span style="position: absolute; top: 57mm; left: 118.7mm;" ><?php echo $contribuyente["nro_docu_identidad"]; ?> </span>
            <span style="position: absolute; top: 57mm; left: 54.7mm;" ><?php echo $contribuyente["persona_id"]; ?> </span>
            <span style="position: absolute; top: 62.5mm; left: 54.7mm;" ><?php echo $contribuyente["apellidos_nombres"]; ?> </span>
            <span style="position: absolute; top: 67mm; left: 54.7mm; width: 48%; font-size: 6pt; line-height: 6pt;" ><?php echo strtoupper($contribuyente["domicilio_completo"]); ?> </span>

            <table style="position: absolute; top: 79mm; width: 70.5%; font-size: 6pt; font-weight: bold;left: 13.5%; text-align: center;">
                    <tbody>
    <?php
    ...
    ?>
            ...
            <table style="position: absolute; top: 110.5mm; width: 73%; font-size: 6pt; font-weight: bold;left: 12.2%; text-align: center;">
                    <tbody>
    <?php
    ...
    <?php
                while ($HR = $consulta_pie_hr->fetch_array()) {
                    ?>
                        <div style="position: relative; top: 193.2mm; font-size: 7pt;">
                        ...
                        <span style="position: relative; left: 125mm; bottom:5px;"><?php echo number_format($HR["impuestoPredial"], 2, ',', '.');?></span>
                    </div>
                    <?php
                }
    ?>
    ...
    <?php
        ...
        ?>
            ...
            <div style="overflow: hidden; display: block; width: 100% ; height: 250mm; position:relative; font-size: 6pt; font-family: Arial; font-weight: bold; page-break-after: always;">
            <span style="position: absolute; top: 35.2mm; left: 101.5mm;"> <?php echo $contribuyente["NroDeclaracionJurada"]; ?> </span>
            <span style="position: absolute; top: 45.7mm; left: 133.2mm;"><?php echo $contribuyente["emision"]; ?> </span>
            <span style="position: absolute; top: 54mm; left: 118.7mm;" ><?php echo $contribuyente["nro_docu_identidad"]; ?> </span>
            <span style="position: absolute; top: 54mm; left: 54.7mm;" ><?php echo $contribuyente["persona_id"]; ?> </span>
            <span style="position: absolute; top: 60.5mm; left: 54.7mm;" ><?php echo $contribuyente["apellidos_nombres"]; ?> </span>
            <span style="position: absolute; top: 65mm; left: 54.7mm; width: 48%; font-size: 6pt; line-height: 6pt;" ><?php echo strtoupper($contribuyente["domicilio_completo"]); ?> </span>

            <table style="position: absolute; top: 78mm; width: 70.5%; font-size: 6pt; font-weight: bold;left: 13.5%; text-align: center;">
                <tbody>
<?php
...
?>
            ...
            <table style="position: absolute; top: 109.5mm; width: 73%; font-size: 6pt; font-weight: bold;left: 12.2%; text-align: center;">
                <tbody>
<?php
...
<?php
            while ($HR = $consulta_pie_hr->fetch_array()) {
                ?>
                     <div style="position: relative; top: 191.5mm; font-size: 7pt;">
                        <span style="position: relative; left: 48mm; bottom:5px;"><?php echo $HR["cantidadPredios"];?></span>
                        <span style="position: relative; left: 76mm; bottom:5px;"><?php echo $HR["PrediosAfectos"];?></span>
                        <span style="position: relative; left: 101mm; bottom:5px;"><?php echo number_format($HR["valor_TotalAfecto"], 2, ',', '.');?></span>
                        <span style="position: relative; left: 125mm; bottom:5px;"><?php echo number_format($HR["impuestoPredial"], 2, ',', '.');?></span>
